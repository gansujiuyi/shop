		...
		<div class="page co" >
			...
			<div class="account-content fr" style="min-height: 477px;">
				<div class="account-item">
					<h2 class="h2-redTag"><span></span>修改密码</h2>
					<!--绑定流程  begin-->
					...
					<!--绑定流程  end-->
					<form class="bound-phone" action="<%=path %>/memberInfo/toUpdatTel3.html" method="post" id="updateForm">
						...
						<ul>
							<li>
								<label>填写旧密码：</label><input class="input-218" type="text"  style="width: 148px;"  /><span class="ml10"></span>
							</li>
							<li>
								<label>填写新密码：</label><input class="input-218" type="text" style="width: 148px;"  /><span class="ml10"></span>
							</li>
							<li>
								<label>确认新密码：</label><input class="input-218" type="text" name="mpassWord" value="${memberInfos.mpassWord }" style="width: 148px;"  /><span class="ml10"> </span>
							</li>
<!-- 							<li> -->
